...
$postShow = new PostShow();
$post = $postShow->getPost($_GET['id']);
?>
...
<body>
    <section class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
            ...
            <a href="/php-mysql-training/services/PostExport.php" class="justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Export PDF</a>
            ...
            <?php if ($post['user_id'] === $_SESSION['user']['id']): ?>
                ...
                <a href="/php-mysql-training/services/PostDelete.php/?id=<?php echo $_GET['id']; ?>" class="justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500">Delete</a>
            <?php endif; ?>
