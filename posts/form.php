<form action="<?php echo $action; ?>" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div class="sm:col-span-2">
            ...
            <div class="mt-2.5">
                <input value="<?php echo $post['title'] ?? null; ?>" id="title" type="text" name="title" autocomplete="title" class="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500" />
            </div>
        ...
        <div class="sm:col-span-2">
            ...
            <div class="mt-2.5">
                <textarea id="body" name="body" rows="4" class="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"><?php echo $post['body'] ?? null; ?></textarea>
            </div>
