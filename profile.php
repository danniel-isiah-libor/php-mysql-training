...
<?php include_once './services/user-loggedin.php'; ?>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img src="/php-mysql-training/imgs/eye.jpg" alt="Your Company" class="size-8" />
          </div>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            <div class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Welcome 
...
<?php include_once './oop/Profile.php'; 
    $profile = new Profile();
